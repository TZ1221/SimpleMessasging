...
public class ChatterMessage {
	...
	public enum MessageType {
		/**
		 * Message sent by the user attempting to initialize in server end.
		 */
		HELLO("HLO"),
		/**
		 ...
		 */
		LEAVE("LEV"),
		/** ChatterMessage sent by the server acknowledging a successful log in. */
		ACKNOWLEDGE("ACK"),
		/** ChatterMessage sent by the server rejecting a login attempt. */
		NO_ACKNOWLEDGE("NAK"),
		/**
		 * ChatterMessage sent by the user to start the logging out process and sent by the
		 * server once the logout process completes.
		 */
		QUIT("BYE"),
		/** ChatterMessage whose contents is broadcast to all connected users. */
		BROADCAST("BCT");
		...
		/**
		 * Return a representation of this ChatterMessage as a String.
		 *
	 ...
	 */
	private ChatterMessage(MessageType handle, String srcName, String text) {
		msgType = handle;
	 ...
	 * @param handle Handle for the type of message being created.
	 */
	private ChatterMessage(MessageType handle) {
	 ...
	 */
	private ChatterMessage(MessageType handle, String srcName) {
	 ...
	 *
	 * @return Instance of ChatterMessage that specifies the process is logging out.
	 */
	public static ChatterMessage makeQuitMessage(String myName) {
		return new ChatterMessage(MessageType.QUIT, myName, null);
	}
	 ...
	 */
	protected static ChatterMessage makeHelloMessage(String text) {
		return new ChatterMessage(MessageType.HELLO, null, text);
	}
	 ...
	 */
	public static ChatterMessage makeBroadcastMessage(String myName, String text) {
		return new ChatterMessage(MessageType.BROADCAST, myName, text);
	}
	 ...
	 * @return Instance of ChatterMessage that transmits text to all logged in users.
	 */
	public static ChatterMessage makeCreateMessage(String myName, String groupName) {
		return new ChatterMessage(MessageType.CREATE, myName, groupName);
	}
	 ...
	 * @return Instance of ChatterMessage that transmits text to all logged in users.
	 */
	public static ChatterMessage makeJoinMessage(String myName, String groupName) {
		return new ChatterMessage(MessageType.JOIN, myName, groupName);
	}
	 ...
	 * @return Instance of ChatterMessage that transmits text to all logged in users.
	 */
	public static ChatterMessage makeDeleteMessage(String myName, String groupName) {
		return new ChatterMessage(MessageType.DELETE, myName, groupName);
	}
	 ...
	 * @return Instance of ChatterMessage that transmits text to all logged in users.
	 */
	public static ChatterMessage makeLeaveMessage(String myName, String groupName) {
		return new ChatterMessage(MessageType.LEAVE, myName, groupName);
	}
	 ...
	 * @return Instance of ChatterMessage that transmits text to all logged in users.
	 */
	public static ChatterMessage makeGroupMessage(String myName, String groupText) {
		return new ChatterMessage(MessageType.GROUP, myName, groupText);
	}
	 ...
	 * @return Instance of ChatterMessage that transmits text to all logged in users.
	 */
	public static ChatterMessage makePrivateMessage(String myName, String privateText) {
		return new ChatterMessage(MessageType.PRIVATE, myName, privateText);
	}
	 ...
	 * @return Instance of ChatterMessage (or its subclasses) representing the handle,
	 *         name, & text.
	 */
	protected static ChatterMessage makeMessage(String handle, String srcName, String text) {
		ChatterMessage result = null;
	 ...
	 *
	 * @return Instance of ChatterMessage that rejects the bad login attempt.
	 */
	public static ChatterMessage makeNoAcknowledgeMessage() {
		return new ChatterMessage(MessageType.NO_ACKNOWLEDGE);
	}
	 ...
	 * @return Instance of ChatterMessage that acknowledges the successful login.
	 */
	public static ChatterMessage makeAcknowledgeMessage(String srcName) {
		return new ChatterMessage(MessageType.ACKNOWLEDGE, srcName);
	}
	 ...
	 */
	public static ChatterMessage makeLoginMessage(String username, String text) {
		return new ChatterMessage(MessageType.LOGIN, username, text);
	}
	 ...
	 * @return Instance of ChatterMessage specifying a new friend has just logged in.
	 */
	public static ChatterMessage makeRegisterMessage(String username, String text) {
		return new ChatterMessage(MessageType.REGISTER, username, text);
	}
